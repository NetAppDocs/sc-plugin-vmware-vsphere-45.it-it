...
+
Se sei già un utente SnapCenter, devi migrare i backup e i metadati delle VM e dei datastore esistenti di SnapCenter. Per informazioni sulla migrazione, consulta link:scpivs44_migrate.html#migration-options["Opzioni di migrazione"^].
