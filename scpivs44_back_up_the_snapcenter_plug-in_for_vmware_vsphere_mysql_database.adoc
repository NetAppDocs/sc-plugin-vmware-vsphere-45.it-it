...
TIP: I nomi di backup dei repository hanno il prefisso "nsm" o "SC_Quartz". Poiché la funzione di ripristino del repository cerca tali prefissi, non è necessario modificarli.
